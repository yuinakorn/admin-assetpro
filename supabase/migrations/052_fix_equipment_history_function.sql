-- Migration: 052_fix_equipment_history_function.sql
-- Description: Fix log_equipment_changes function to remove references to the old 'type' column
-- Date: 2024-12-19
-- Author: Assistant
...
-- Update the log_equipment_changes function to remove type column references
...
BEGIN
  ...
  ELSIF TG_OP = 'UPDATE' THEN
    ...
    -- Check specific field changes (removed type field check)
