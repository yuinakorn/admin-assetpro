-- Computer Equipment Asset Management System Database Schema
...
('admin', 'admin@company.com', '$2b$10$...', 'ผู้ดูแล', 'ระบบ', 'admin', (SELECT id FROM departments WHERE code = 'IT')),
('manager1', 'manager@company.com', '$2b$10$...', 'สมชาย', 'ใจดี', 'manager', (SELECT id FROM departments WHERE code = 'IT')),
('user1', 'user1@company.com', '$2b$10$...', 'มานี', 'สบายดี', 'user', (SELECT id FROM departments WHERE code = 'HR'));

-- Insert sample equipment
INSERT INTO equipment (name, type, brand, model, serial_number, asset_number, department_id, current_user_id, status, warranty_date) VALUES
('คอมพิวเตอร์ตั้งโต๊ะ Dell OptiPlex 7090', 'computer', 'Dell', 'OptiPlex 7090', '7XKWN3J', 'PC001', (SELECT id FROM departments WHERE code = 'IT'), (SELECT id FROM users WHERE username = 'manager1'), 'normal', '2025-12-31'),
('โน้ตบุ๊ค Lenovo ThinkPad E14', 'laptop', 'Lenovo', 'ThinkPad E14', 'PC1A2B3C', 'NB001', (SELECT id FROM departments WHERE code = 'HR'), (SELECT id FROM users WHERE username = 'user1'), 'normal', '2024-08-15'),
('เครื่องพิมพ์ HP LaserJet Pro 404dn', 'printer', 'HP', 'LaserJet Pro 404dn', 'VNC8K12345', 'PR001', (SELECT id FROM departments WHERE code = 'ACC'), NULL, 'maintenance', '2024-03-20');
