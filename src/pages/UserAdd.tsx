...
import { ArrowLeft, Save, Plus, Loader2, Eye, EyeOff } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await UserService.createUser({
        ...
        password_hash: formData.password, // In real app, hash this password
      ...
      toast({
        title: "เกิดข้อผิดพลาด",
        description: "ไม่สามารถเพิ่มผู้ใช้งานได้",
        variant: "destructive"
      })
    } finally {
      setLoading(false)
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">เพิ่มผู้ใช้งานใหม่</h1>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {formData.is_active 
                      ? "ผู้ใช้งานนี้จะสามารถเข้าสู่ระบบได้ทันที" 
